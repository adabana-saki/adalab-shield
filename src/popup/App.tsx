...
export function App() {
  ...
  const openHelp = () => {
    // openOptionsPage() can't carry a hash, so open the page directly and
    // deep-link to the usage guide.
    void browser.tabs.create({
      url: browser.runtime.getURL('src/options/index.html#help'),
    });
  };
  ...
  return (
    <div className="popup-container">
      ...
      <footer className="popup-footer-new">
        <button type="button" className="popup-settings-btn" onClick={openHelp}>
          <svg
            viewBox="0 0 24 24"
            fill="none"
            stroke="currentColor"
